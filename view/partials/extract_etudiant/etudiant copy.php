...
<head>
    ...
    <script type="text/javascript" src="js/etu_animation1.js"></script>
...
********/
    ...
    if(isset($_REQUEST['nom_mat'], $_REQUEST['coef_mat'], 
        $_REQUEST['code_mat']))
     {
    
    require('../config/connexion.php');
    // Insertion du message à l'aide d'une requête préparée
    $req = $con->prepare('INSERT INTO matiere_igl2 (nom_mat, coef_mat, code_mat, idProf )
    VALUES(?, ?, ?, ?)');
    ...
    if(isset($_REQUEST['note_eval'], $_REQUEST['id_mat'], 
    ...
    // Insertion du message à l'aide d'une requête préparée
    $id = $_GET['id'];
    $req = $con->prepare('INSERT INTO evaliation_igl2 (note_eval, id_mat, id_etudiant )
    VALUES(?, ?, ?)');
...
?>
    ...
    <!---img.php------>
        ...
        $id = $_GET['id']  ;
        $req = $con->query("SELECT * FROM  etudiant_igl2 WHERE id = $id");
        ...
        <div class="container_left">                <img src="img.php?id=<?=$donnees['id']?>" class="icon_button" style="position:relative; left:5vh; width: 17vh; border-radius:28vh;  height: 16vh;"alt="" srcset="">
        ...
        <?php	
            ...
            <div class="box_left" onclick="window.open(); return false;">
                <div class="icon_button" style="background-image: url(img/question.png);"> </div>
                <div class="buttons_container" style=" left:-4vh;   position: relative;  " ><?php echo $donnees['etu_email']; ?></div>
            </div>
            ...
            <div class="register">
                ...
                <!------------ E T U D I A N T--------->
                   ...
                   <!-- <div class="reg_inputs">
                    ...
                    <form class="reg_matiere" action="" method="POST">
                    <div class="reg_inputs">
                            <label for="card_number" class="labels">Nom:</label>
                        ...
                        ?>
                            ...
                            <select class="reg_select"  style="color: white; position:relative; border-radius:3vh; bottom:6vh; left:1vh; width:24vh ;background-color: #9400D3;"  >
                                ...
                                ?>
                                                      ...
                                                      <input type="text" class="inputs" name="idProf" id="card_date" style="position:relative; border-radius:3vh; bottom:12vh; left:43vh; width:5vh ;"placeholder="ID">
                    ...
                    <form class="reg_evaliation" action="" method="POST">
                        ...
                        ?>
                            ...
                            <option  style="color:black; width:7vh; background-color:white; border-radius:3vh;"  
                               value="idProf"><?php echo $donnees['id'],"->", $donnees['nom_mat'] ; ?>  </option>                               
                            <?php	
                             }
                            ?>                         
                            </select> 
                            <input type="text" class="inputs" name="id_mat" id="card_date"
                        ...
                        ?>
                         <?php
                            ...
                            <div class="reg_inputs1">
                              ...
                              left:1vh; width:10vh ;" >Coef : <?php echo  $donnees['coef_mat']; ?></p>
                            </div> 
                               <?php	
                                   }
                            ?> 
...
<form id="" class="info_tables " method="POST">
       ...
       <div class="reg_note">
           <input type="submit" class="buttons1" name="butProf" style="margin-left: 60px;" value="Save">
           <input type="submit" class="buttons2"  name="button" onclick="new_reg_controller('close');" value="Close">
...
?>
        ...
        ?>
            ...
            ?>
                ...
                <td><a href="view/update.php?id=<?=$row['id']?>"><img style="height: 25px; color:azure;" src="img/pen.png" alt="" srcset=""></td>
